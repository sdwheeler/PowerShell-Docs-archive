---
description: GetProc02 Code Samples
ms.date: 09/13/2016
title: GetProc02 Code Samples
---
# GetProc02 Code Samples

Here are the code samples for the GetProc02 sample cmdlet. This is the `Get-Process` cmdlet sample described in [Adding Parameters that Process Command-Line Input](/powershell/scripting/developer/cmdlet/adding-parameters-that-process-command-line-input.md). This `Get-Process` cmdlet retrieves processes based on their name, and then displays information about the processes at the command line.
